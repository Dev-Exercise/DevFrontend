      ...
      <div className="flex justify-between">
        <div className="my-4">
          ...
          <input
            ...
            class=" px-4 w-80 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div className="flex items-center">
          ...
          >
            ...
            <option value="option2">Covered Distance Greater Than 2 KM</option>
          </select>
        </div>
      </div>
